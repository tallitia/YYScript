...
namespace RoyT.AStar
{
    ...
    {
        internal static List<Step> StepList = new List<Step>(0);

        [Conditional("DEBUG")]
        private static void MessageCurrent(Position position, List<Position> path)
        {                        
    ...
    internal class Step
    {
        ...
        public StepType Type { set; get; }
        public Position Position { set; get; }
        public List<Position> Path { set; get; }
    }
